...
/*=======================================================================================
** _TBDAPP__InitTable() test cases
**=======================================================================================*/

void Ut__TBDAPP__InitTable(void)
{
    int32 retCode = -1;

    /* ----- Test case #1 - Nominal ----- */
    /* Setup additional inputs
       - Make _TBDTBL_ table available to ut_assert */
    Ut_CFE_TBL_ClearTables();
    Ut_CFE_TBL_AddTable(_TBDAPP___TBDTBL__FILENAME, &g__TBDAPP___tbdTbl_Tbl);
    /* Execute test */
    retCode = _TBDAPP__InitTable();
    /* Verify outputs */
    UtAssert_True(retCode == CFE_SUCCESS, "_InitTable() - 1/2:Nominal");
    
    /* ----- Test case #2 - Init_TbdTbl_Failed----- */
    /* Setup additional inputs
       - Force CFE_TBL_Register() to return an error */
    Ut_CFE_TBL_SetReturnCode(UT_CFE_TBL_REGISTER_INDEX, CFE_TBL_ERR_INVALID_SIZE, 1);
    /* Execute test */
    retCode = _TBDAPP__InitTable();
    /* Verify outputs */
    UtAssert_True(retCode != CFE_SUCCESS, "_InitTable() - 2/2:Init_TbdTbl_Failed");
}
...
void Ut__TBDAPP__InitApp(void)
{
    ...
    /* Verify outputs */
    UtAssert_True(retCode == CFE_SUCCESS, "_InitApp() - 1/4:Nominal");
    ...
    retCode = _TBDAPP__InitApp();
    /* Verify outputs */
    UtAssert_True(retCode != CFE_SUCCESS, "_InitApp() - 2/4:InitEventFail");
    ...
    retCode = _TBDAPP__InitApp();
    /* Verify outputs */
    UtAssert_True(retCode != CFE_SUCCESS, "_InitApp() - 3/4:InitPipeFail");

    /* ----- Test case #4 - InitTableFail ----- */
    /* Setup additional inputs
       - Force CFE_TBL_Register() to return error */
    Ut_CFE_TBL_SetReturnCode(UT_CFE_TBL_REGISTER_INDEX, CFE_TBL_ERR_INVALID_SIZE, 1);
    /* Execute test */
    retCode = _TBDAPP__InitApp();
    /* Verify outputs */
    UtAssert_True(retCode != CFE_SUCCESS, "_InitApp() - 4/4:InitTableFail");
}
...
/*=======================================================================================
** _TBDAPP__Init_TbdTbl_Table() test cases
**=======================================================================================*/

void Ut__TBDAPP__Init_TbdTbl_Table(void)
{
    int32 retCode = -1;
    ...
    Ut_CFE_TBL_AddTable(_TBDAPP___TBDTBL__FILENAME, &g__TBDAPP___tbdTbl_Tbl);
    /* Execute test */
    retCode = _TBDAPP__Init_TbdTbl_Table();
    /* Verify outputs */
    UtAssert_True(retCode == CFE_SUCCESS, "_Init_TbdTbl_Table() - 1/5:Nominal");

    /* ----- Test case #2 - TableRegisterFailed ----- */
    /* Setup additional inputs
       - Force CFE_TBL_Register() to return an error */
    Ut_CFE_TBL_SetReturnCode(UT_CFE_TBL_REGISTER_INDEX, CFE_TBL_ERR_INVALID_SIZE, 1);
    /* Execute test */
    retCode = _TBDAPP__Init_TbdTbl_Table();
    /* Verify outputs */
    UtAssert_True(retCode != CFE_SUCCESS, "_Init_TbdTbl_Table() - 2/5:TableRegisterFailed");

    /* ----- Test case #3 - TableLoadFailed ----- */
    /* Setup additional inputs
       - Force CFE_TBL_Load() to return an error */
    Ut_CFE_TBL_SetReturnCode(UT_CFE_TBL_LOAD_INDEX, CFE_TBL_ERR_NO_ACCESS, 1);
    /* Execute test */
    retCode = _TBDAPP__Init_TbdTbl_Table();
    /* Verify outputs */
    UtAssert_True(retCode != CFE_SUCCESS, "_Init_TbdTbl_Table() - 3/5:TableLoadFailed");

    /* ----- Test case #4 - TableManageFailed ----- */
    /* Setup additional inputs
       - Force CFE_TBL_Manage() to return an error */
    Ut_CFE_TBL_SetReturnCode(UT_CFE_TBL_MANAGE_INDEX, CFE_TBL_ERR_NO_ACCESS, 1);
    /* Execute test */
    retCode = _TBDAPP__Init_TbdTbl_Table();
    /* Verify outputs */
    UtAssert_True(retCode != CFE_SUCCESS, "_Init_TbdTbl_Table() - 4/5:TableManageFailed");

    /* ----- Test case #5 - TableGetAddressFailed ----- */
    /* Setup additional inputs
       - Force CFE_TBL_GetAddress() to return an error */
    Ut_CFE_TBL_SetReturnCode(UT_CFE_TBL_GETADDRESS_INDEX, CFE_TBL_ERR_INVALID_HANDLE, 1);
    /* Execute test */
    retCode = _TBDAPP__Init_TbdTbl_Table();
    /* Verify outputs */
    UtAssert_True(retCode != CFE_SUCCESS, "_Init_TbdTbl_Table() - 5/5:TableGetAddressFailed");
}

/*=======================================================================================
** _TBDAPP__Validate_TbdTbl_Table() test cases
**=======================================================================================*/

void Ut__TBDAPP__Validate_TbdTbl_Table(void)
{
    int32 retCode = 0;
    ...
    /* Setup additional inputs - none */
    /* Execute test */
    retCode = _TBDAPP__Validate_TbdTbl_Table(&g__TBDAPP___tbdTbl_Tbl);
    /* Verify outputs */
    UtAssert_True(retCode == CFE_SUCCESS, "_Validate_TbdTbl_Table() - 1/2:Nominal");

    /* ----- Test case #2 - NullPointer ----- */
    /* Setup additional inputs - none */
    /* Execute test */
    retCode = _TBDAPP__Validate_TbdTbl_Table(NULL);
    /* Verify outputs */
    UtAssert_True(retCode != CFE_SUCCESS, "_Validate_TbdTbl_Table() - 2/2:NullPointer");
}

/*=======================================================================================
** _TBDAPP__ProcessNew_TbdTbl_Table() test cases
**=======================================================================================*/

void Ut__TBDAPP__ProcessNew_TbdTbl_Table(void)
{
    int32 retCode = 0;

    /* ----- Test case #1 - Nominal ----- */
    /* Setup additional inputs
       - Set table pointer to _TBDTBL_ table */
    g__TBDAPP__AppData.p_TbdTbl_Tbl = &g__TBDAPP___tbdTbl_Tbl;
    /* Execute test */
    retCode = _TBDAPP__ProcessNew_TbdTbl_Table();
    /* Verify outputs */
    UtAssert_True(retCode == CFE_SUCCESS, "_ProcessNew_TbdTbl_Table() - 1/2:Nominal");

    /* ----- Test case #2 - NullPointer ----- */
    /* Setup additional inputs
       - Set table pointer to NULL */
    g__TBDAPP__AppData.p_TbdTbl_Tbl = NULL;
    /* Execute test */
    retCode = _TBDAPP__ProcessNew_TbdTbl_Table();
    /* Verify outputs */
    UtAssert_True(retCode != CFE_SUCCESS, "_ProcessNew_TbdTbl_Table() - 2/2:NullPointer");
}
